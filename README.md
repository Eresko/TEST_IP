...
### Слой логики 
   ...
   3. **Расширяемость** Чтобы добавить новый канал (например, SMS), достаточно создать SmsProvider и добавить одну строку в AppServiceProvider. Основной код SendService остается нетронутым выполнояем Open-Closed
### Асинхронность
