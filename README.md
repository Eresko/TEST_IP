...
### Реактивность
   1. **NotificationObserver**  Инкапсулирует логику побочных эффектов. Как только воркер обновляет статус в БД на DELIVERED или DISCARDED, фиксируем это дейстие
